...
public class V1Event implements io.kubernetes.client.common.KubernetesObject {
  ...
  **/
  ...
  public V1Event eventTime(OffsetDateTime eventTime) {
  ...
  **/
  ...
  public V1Event firstTimestamp(OffsetDateTime firstTimestamp) {
  ...
  **/
  ...
  public V1Event lastTimestamp(OffsetDateTime lastTimestamp) {
