...
public class V1Scale implements io.kubernetes.client.common.KubernetesObject {
  ...
  private V1ScaleStatus status;


  public V1Scale apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1Scale kind(String kind) {
  ...
  **/
  ...
  public V1Scale metadata(V1ObjectMeta metadata) {
  ...
  **/
  ...
  public V1Scale spec(V1ScaleSpec spec) {
  ...
  **/
  ...
  public void setSpec(V1ScaleSpec spec) {
    this.spec = spec;
  }


  public V1Scale status(V1ScaleStatus status) {
  ...
  **/
  ...
  public void setStatus(V1ScaleStatus status) {
    this.status = status;
  }
