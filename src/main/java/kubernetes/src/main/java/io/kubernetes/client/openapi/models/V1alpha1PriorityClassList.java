...
public class V1alpha1PriorityClassList implements io.kubernetes.client.common.KubernetesListObject {
  ...
  private List<V1alpha1PriorityClass> items = new ArrayList<>();
