...
public class V1ReplicationControllerList implements io.kubernetes.client.common.KubernetesListObject {
  ...
  private List<V1ReplicationController> items = new ArrayList<>();
