...
public class V1PodList implements io.kubernetes.client.common.KubernetesListObject {
  ...
  private List<V1Pod> items = new ArrayList<>();
  ...
  **/
   ...
   * @return items
  **/
  @ApiModelProperty(required = true, value = "List of pods. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md")
  ...
  **/
  ...
  public V1PodList metadata(V1ListMeta metadata) {
