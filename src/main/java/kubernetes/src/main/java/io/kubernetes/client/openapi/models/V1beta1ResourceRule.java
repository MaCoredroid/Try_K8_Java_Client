...
public class V1beta1ResourceRule {
  ...
  public V1beta1ResourceRule apiGroups(List<String> apiGroups) {
  ...
  **/
  ...
  public V1beta1ResourceRule resourceNames(List<String> resourceNames) {
  ...
  **/
  ...
  public V1beta1ResourceRule resources(List<String> resources) {
  ...
  **/
  ...
  public V1beta1ResourceRule verbs(List<String> verbs) {
