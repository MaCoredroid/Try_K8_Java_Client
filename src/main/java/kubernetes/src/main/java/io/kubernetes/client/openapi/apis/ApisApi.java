...
public class ApisApi {
    ...
    private okhttp3.Call getAPIVersionsValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAPIVersionsCall(_callback);
        return localVarCall;
    ...
    public V1APIGroupList getAPIVersions() throws ApiException {
        ApiResponse<V1APIGroupList> localVarResp = getAPIVersionsWithHttpInfo();
     ...
     */
    public okhttp3.Call getAPIVersionsAsync(final ApiCallback<V1APIGroupList> _callback) throws ApiException {
