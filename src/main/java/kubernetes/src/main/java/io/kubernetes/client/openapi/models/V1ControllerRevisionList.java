...
public class V1ControllerRevisionList implements io.kubernetes.client.common.KubernetesListObject {
  ...
  public V1ControllerRevisionList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1ControllerRevisionList items(List<V1ControllerRevision> items) {
  ...
  **/
  ...
  public void setItems(List<V1ControllerRevision> items) {
    this.items = items;
  }


  public V1ControllerRevisionList kind(String kind) {
  ...
  **/
  ...
  public V1ControllerRevisionList metadata(V1ListMeta metadata) {
