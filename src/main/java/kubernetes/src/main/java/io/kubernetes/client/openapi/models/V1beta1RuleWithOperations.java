...
public class V1beta1RuleWithOperations {
  ...
  public V1beta1RuleWithOperations apiGroups(List<String> apiGroups) {
  ...
  **/
  ...
  public V1beta1RuleWithOperations apiVersions(List<String> apiVersions) {
  ...
  **/
  ...
  public V1beta1RuleWithOperations operations(List<String> operations) {
  ...
  **/
  ...
  public V1beta1RuleWithOperations resources(List<String> resources) {
