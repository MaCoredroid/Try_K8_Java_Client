...
public class V2alpha1CronJob implements io.kubernetes.client.common.KubernetesObject {
  ...
  private V2alpha1CronJobSpec spec;

  public static final String SERIALIZED_NAME_STATUS = "status";
  @SerializedName(SERIALIZED_NAME_STATUS)
  private V2alpha1CronJobStatus status;
