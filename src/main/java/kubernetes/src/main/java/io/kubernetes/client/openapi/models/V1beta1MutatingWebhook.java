...
public class V1beta1MutatingWebhook {
  ...
  public V1beta1MutatingWebhook admissionReviewVersions(List<String> admissionReviewVersions) {
    
    this.admissionReviewVersions = admissionReviewVersions;
    return this;
  }

  public V1beta1MutatingWebhook addAdmissionReviewVersionsItem(String admissionReviewVersionsItem) {
  ...
  **/
  ...
  public V1beta1MutatingWebhook clientConfig(AdmissionregistrationV1beta1WebhookClientConfig clientConfig) {
  ...
  **/
  ...
  public V1beta1MutatingWebhook failurePolicy(String failurePolicy) {
  ...
  **/
  ...
  public V1beta1MutatingWebhook matchPolicy(String matchPolicy) {
  ...
  **/
  ...
  public V1beta1MutatingWebhook name(String name) {
  ...
  **/
  ...
  public V1beta1MutatingWebhook namespaceSelector(V1LabelSelector namespaceSelector) {
  ...
  **/
  ...
  public V1beta1MutatingWebhook objectSelector(V1LabelSelector objectSelector) {
  ...
  **/
  ...
  public V1beta1MutatingWebhook reinvocationPolicy(String reinvocationPolicy) {
  ...
  **/
  ...
  public V1beta1MutatingWebhook rules(List<V1beta1RuleWithOperations> rules) {
    
    this.rules = rules;
    return this;
  }

  public V1beta1MutatingWebhook addRulesItem(V1beta1RuleWithOperations rulesItem) {
    if (this.rules == null) {
  ...
  **/
  ...
  public V1beta1MutatingWebhook sideEffects(String sideEffects) {
  ...
  **/
  ...
  public V1beta1MutatingWebhook timeoutSeconds(Integer timeoutSeconds) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1beta1MutatingWebhook v1beta1MutatingWebhook = (V1beta1MutatingWebhook) o;
    return Objects.equals(this.admissionReviewVersions, v1beta1MutatingWebhook.admissionReviewVersions) &&
        Objects.equals(this.clientConfig, v1beta1MutatingWebhook.clientConfig) &&
        Objects.equals(this.failurePolicy, v1beta1MutatingWebhook.failurePolicy) &&
        Objects.equals(this.matchPolicy, v1beta1MutatingWebhook.matchPolicy) &&
        Objects.equals(this.name, v1beta1MutatingWebhook.name) &&
        Objects.equals(this.namespaceSelector, v1beta1MutatingWebhook.namespaceSelector) &&
        Objects.equals(this.objectSelector, v1beta1MutatingWebhook.objectSelector) &&
        Objects.equals(this.reinvocationPolicy, v1beta1MutatingWebhook.reinvocationPolicy) &&
        Objects.equals(this.rules, v1beta1MutatingWebhook.rules) &&
        Objects.equals(this.sideEffects, v1beta1MutatingWebhook.sideEffects) &&
        Objects.equals(this.timeoutSeconds, v1beta1MutatingWebhook.timeoutSeconds);
  }

  @Override
  public int hashCode() {
    return Objects.hash(admissionReviewVersions, clientConfig, failurePolicy, matchPolicy, name, namespaceSelector, objectSelector, reinvocationPolicy, rules, sideEffects, timeoutSeconds);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1beta1MutatingWebhook {\n");
