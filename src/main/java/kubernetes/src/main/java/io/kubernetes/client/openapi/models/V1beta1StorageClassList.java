...
public class V1beta1StorageClassList implements io.kubernetes.client.common.KubernetesListObject {
  ...
  private List<V1beta1StorageClass> items = new ArrayList<>();
  ...
  **/
  ...
  public V1beta1StorageClassList metadata(V1ListMeta metadata) {
