 ...
 */
@ApiModel(description = "WebhookClientConfig contains the information to make a connection with the webhook")
...
public class V1alpha1WebhookClientConfig {
  ...
  private V1alpha1ServiceReference service;
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1alpha1WebhookClientConfig v1alpha1WebhookClientConfig = (V1alpha1WebhookClientConfig) o;
    return Arrays.equals(this.caBundle, v1alpha1WebhookClientConfig.caBundle) &&
        Objects.equals(this.service, v1alpha1WebhookClientConfig.service) &&
        Objects.equals(this.url, v1alpha1WebhookClientConfig.url);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1WebhookClientConfig {\n");
