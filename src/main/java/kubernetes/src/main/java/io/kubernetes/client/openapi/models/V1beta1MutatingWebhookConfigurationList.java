...
public class V1beta1MutatingWebhookConfigurationList implements io.kubernetes.client.common.KubernetesListObject {
  ...
  private List<V1beta1MutatingWebhookConfiguration> items = new ArrayList<>();
