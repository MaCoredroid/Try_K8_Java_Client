...
public class V1CustomResourceDefinitionList implements io.kubernetes.client.common.KubernetesListObject {
  ...
  private List<V1CustomResourceDefinition> items = new ArrayList<>();
  ...
  public V1CustomResourceDefinitionList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1CustomResourceDefinitionList items(List<V1CustomResourceDefinition> items) {
    
    this.items = items;
    return this;
  }

  public V1CustomResourceDefinitionList addItemsItem(V1CustomResourceDefinition itemsItem) {
  ...
  **/
  ...
  public void setItems(List<V1CustomResourceDefinition> items) {
    this.items = items;
  }


  public V1CustomResourceDefinitionList kind(String kind) {
  ...
  **/
  ...
  public V1CustomResourceDefinitionList metadata(V1ListMeta metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1CustomResourceDefinitionList v1CustomResourceDefinitionList = (V1CustomResourceDefinitionList) o;
  ...
  public String toString() {
    ...
    sb.append("class V1CustomResourceDefinitionList {\n");
