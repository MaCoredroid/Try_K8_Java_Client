...
public class V1alpha1GroupSubject {
  public static final String SERIALIZED_NAME_NAME = "name";
  @SerializedName(SERIALIZED_NAME_NAME)
  private String name;


  public V1alpha1GroupSubject name(String name) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1alpha1GroupSubject v1alpha1GroupSubject = (V1alpha1GroupSubject) o;
    return Objects.equals(this.name, v1alpha1GroupSubject.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1GroupSubject {\n");
