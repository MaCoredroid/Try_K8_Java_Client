...
public class V1beta1ValidatingWebhookConfigurationList implements io.kubernetes.client.common.KubernetesListObject {
  ...
  private List<V1beta1ValidatingWebhookConfiguration> items = new ArrayList<>();
  ...
  **/
  ...
  public V1beta1ValidatingWebhookConfigurationList items(List<V1beta1ValidatingWebhookConfiguration> items) {
    
    this.items = items;
    return this;
  }

  public V1beta1ValidatingWebhookConfigurationList addItemsItem(V1beta1ValidatingWebhookConfiguration itemsItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1beta1ValidatingWebhookConfigurationList v1beta1ValidatingWebhookConfigurationList = (V1beta1ValidatingWebhookConfigurationList) o;
