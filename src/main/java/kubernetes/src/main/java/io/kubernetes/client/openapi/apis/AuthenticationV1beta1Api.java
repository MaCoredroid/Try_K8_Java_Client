...
public class AuthenticationV1beta1Api {
     ...
     */
    public okhttp3.Call createTokenReviewCall(V1beta1TokenReview body, String dryRun, String fieldManager, String pretty, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createTokenReviewValidateBeforeCall(V1beta1TokenReview body, String dryRun, String fieldManager, String pretty, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createTokenReviewCall(body, dryRun, fieldManager, pretty, _callback);
        return localVarCall;
     ...
     */
    public V1beta1TokenReview createTokenReview(V1beta1TokenReview body, String dryRun, String fieldManager, String pretty) throws ApiException {
        ApiResponse<V1beta1TokenReview> localVarResp = createTokenReviewWithHttpInfo(body, dryRun, fieldManager, pretty);
     ...
     */
    public ApiResponse<V1beta1TokenReview> createTokenReviewWithHttpInfo(V1beta1TokenReview body, String dryRun, String fieldManager, String pretty) throws ApiException {
        okhttp3.Call localVarCall = createTokenReviewValidateBeforeCall(body, dryRun, fieldManager, pretty, null);
     ...
     */
    public okhttp3.Call createTokenReviewAsync(V1beta1TokenReview body, String dryRun, String fieldManager, String pretty, final ApiCallback<V1beta1TokenReview> _callback) throws ApiException {

        okhttp3.Call localVarCall = createTokenReviewValidateBeforeCall(body, dryRun, fieldManager, pretty, _callback);
        Type localVarReturnType = new TypeToken<V1beta1TokenReview>(){}.getType();
