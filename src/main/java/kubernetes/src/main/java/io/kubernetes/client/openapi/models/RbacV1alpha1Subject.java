...
public class RbacV1alpha1Subject {
  ...
  public RbacV1alpha1Subject apiVersion(String apiVersion) {
  ...
  **/
  ...
  public RbacV1alpha1Subject kind(String kind) {
  ...
  **/
  ...
  public RbacV1alpha1Subject name(String name) {
  ...
  **/
  ...
  public RbacV1alpha1Subject namespace(String namespace) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RbacV1alpha1Subject rbacV1alpha1Subject = (RbacV1alpha1Subject) o;
    return Objects.equals(this.apiVersion, rbacV1alpha1Subject.apiVersion) &&
        Objects.equals(this.kind, rbacV1alpha1Subject.kind) &&
        Objects.equals(this.name, rbacV1alpha1Subject.name) &&
        Objects.equals(this.namespace, rbacV1alpha1Subject.namespace);
  }
  ...
  public String toString() {
    ...
    sb.append("class RbacV1alpha1Subject {\n");
