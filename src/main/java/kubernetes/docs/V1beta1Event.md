...
**deprecatedFirstTimestamp** | [**OffsetDateTime**](OffsetDateTime.md) | Deprecated field assuring backward compatibility with core.v1 Event type |  [optional]
**deprecatedLastTimestamp** | [**OffsetDateTime**](OffsetDateTime.md) | Deprecated field assuring backward compatibility with core.v1 Event type |  [optional]
**deprecatedSource** | [**V1EventSource**](V1EventSource.md) |  |  [optional]
**eventTime** | [**OffsetDateTime**](OffsetDateTime.md) | Required. Time when this Event was first observed. | 
