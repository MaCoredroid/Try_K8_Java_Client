...
public class V1alpha1FlowSchemaCondition {
  ...
  **/
  ...
  public V1alpha1FlowSchemaCondition message(String message) {
  ...
  **/
  ...
  public V1alpha1FlowSchemaCondition reason(String reason) {
  ...
  **/
  ...
  public V1alpha1FlowSchemaCondition status(String status) {
  ...
  **/
  ...
  public V1alpha1FlowSchemaCondition type(String type) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1alpha1FlowSchemaCondition v1alpha1FlowSchemaCondition = (V1alpha1FlowSchemaCondition) o;
    return Objects.equals(this.lastTransitionTime, v1alpha1FlowSchemaCondition.lastTransitionTime) &&
        Objects.equals(this.message, v1alpha1FlowSchemaCondition.message) &&
        Objects.equals(this.reason, v1alpha1FlowSchemaCondition.reason) &&
        Objects.equals(this.status, v1alpha1FlowSchemaCondition.status) &&
        Objects.equals(this.type, v1alpha1FlowSchemaCondition.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1FlowSchemaCondition {\n");
